...
import { loginUser, registerUser,logoutUser,getUserChannelProfile, changeAvatarImage, changeCoverImage,changeAccountDetails, changeUserPassword, getWatchHistory,getCurrentUser, getAllNotification} from "../controllers/user.controller.js";
...
userRoute.route("/current-user").get(verifyJsonWebToken);
